...
<tr>
  <td style="background-color: #CFD8DC;">
    <!--[if (gte mso 9)|(IE)]>
    ...
    <table bgcolor="#ffffff" class="content" align="center" cellpadding="0" cellspacing="0" border="0">
			<tr style="border-bottom: 3px solid #B0BEC5;">
				<td valign="top" mc:edit="headerBrand" id="templateContainerHeader">

					<p style="text-align:left;margin:0;padding-left: 2em;">
						<!-- <img id="header-image" src="https://gilitransfers.com/img/logo.png" /> -->
					</p>

				</td>
        <td style="width: 100%; text-align: right; padding-right: 2em; color: #546E7A;" class="bodyContent" mc:edit="body_content">
          <p style="text-align: right; font-size:11px !important;">2018-05-13 23:30:15</p>
        </td>
			</tr>
      <tr>
				<td colspan="2" align="center" valign="top">
                  ...
                  <h4>Kepada Yth  pengguna <?= $user->username ?></h4>
                  <h4>Salam Hangat dari admin Disperindag Banyuwangi</h4>
									<p style="text-align: justify;">Sistem Kami telah mendeteksi bahwa anda telah melakukan permintaan request password baru, untuk mengatur ulang password anda silahkan mengkases tautan dibawah ini: </p>
								</td>
							</tr>
						</table>
						<!-- // END BODY -->
      ...
      <tr>
        <td colspan="2">
          <table border="0" cellpadding="0" cellspacing="0" width="100%">
              <tr>
                <td width="10%" valign="middle" class="bodyContent customerInfo" mc:edit="body_content">
                  <p>link untuk Mengatur ulang password</p>
                </td>
                <td  valign="middle" class="bodyContent customerInfo">
                  <?php $resetLink = Yii::$app->urlManager->createAbsoluteUrl(['user/atur-ulang-password', 'token' => $user->password_reset_token]); ?>
                 <p><?= Html::a('Klik Disini', $resetLink) ?></p>
                </td>
              </tr>
            </table>
        </td>
      ...
      <tr>
        <td colspan="2" align="center" valign="top">
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateContainerMiddle">
              <tr>
                <td valign="top" class="bodyContent customerInfo" mc:edit="body_content">
                  <p style="text-align: justify;">Jika anda merasa tidak melakukan hal ini abaikan saja email ini dan tetap beraktifitas seperti biasa, terimakasih </p>
                </td>
              </tr>
            </table>
            <!-- // END BODY -->
												...
												<table border="0" cellpadding="0" cellspacing="0" valign="top">
													<tr>
														...
														<td align="left" valign="top" mc:edit="footer_sig" valign="top" style="margin:0;padding-top:10px;line-height:1;">
															<h4><strong>Salam</strong></h4>
															<h5>Admin Disperindag</h5>
														</td>
													</tr>
												</table>
											</td>
			...
			<tr>
				<td colspan="2" align="center" valign="top" id="bodyCellFooter" class="unSubContent">
					<table width="100%" border="0" cellpadding="0" cellspacing="0" id="templateContainerFooter">
						<tr>
							<td valign="top" width="100%" mc:edit="footer_unsubscribe">
								<h6 style="text-align:center;">Jl A. Yani , Tukangkayu Kecamatan Banyuwangi</h6>
								<h6 style="text-align:center;">Banyuwngi Jawa timur Indonesia</h6>
							</td>
						</tr>
					</table>
				</td>
